...
$branch=$_POST['branch'];
$query=mysqli_query($con,"update users set fullName='$fullname',contactNo='$contactno',university='$university',college='$college',prn='$prn',branch='$branch' where userEmail='".$_SESSION['login']."'");
if($query)
{
...
<div class="col-sm-4">
<textarea  name="university" required="required" class="form-control"><?php echo htmlentities($row['university']);?></textarea>
</div>
</div>

<label class="col-sm-2 col-sm-2 control-label">College</label>
<div class="col-sm-4">
<textarea  name="college" required="required" class="form-control"><?php echo htmlentities($row['college']);?></textarea>
</div>


</select>
</div>
<label class="col-sm-2 col-sm-2 control-label">PRN </label>
<div class="col-sm-4">
